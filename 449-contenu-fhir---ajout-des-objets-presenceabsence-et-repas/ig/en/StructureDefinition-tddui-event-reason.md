# TDDUI Event Reason - Médicosocial - Transfert de données DUI v2.3.0-ballot
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ans.fhir.fr.tddui|current/StructureDefinition/StructureDefinition-tddui-event-reason.json)
