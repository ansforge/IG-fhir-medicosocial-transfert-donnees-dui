# TDDUI DocumentReference - Médicosocial - Transfert de données DUI v2.3.0-ballot
...
| | |
| :--- | :--- |
| *Official URL*:https://interop.esante.gouv.fr/ig/fhir/tddui/StructureDefinition/tddui-document-reference | *Version*:2.3.0-ballot |
