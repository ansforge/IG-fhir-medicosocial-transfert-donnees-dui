...
| | |
| :--- | :--- |
| *Official URL*:https://interop.esante.gouv.fr/ig/fhir/tddui/StructureDefinition/tddui-service-demande-orientation | *Version*:2.3.0-ballot |
| Active as of 2026-03-11 | *Computable Name*:TDDUIServiceRequestDemandeOrientation |
...
Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.fhir.fr.tddui|current/StructureDefinition/tddui-service-demande-orientation)
...
Other representations of profile: [CSV](StructureDefinition-tddui-service-demande-orientation.csv), [Excel](StructureDefinition-tddui-service-demande-orientation.xlsx), [Schematron](StructureDefinition-tddui-service-demande-orientation.sch) 
...
```json
{
  ...
  "url" : "https://interop.esante.gouv.fr/ig/fhir/tddui/StructureDefinition/tddui-service-demande-orientation",
