# TDDUI Task Transport Example - Médicosocial - Transfert de données DUI v2.3.0-ballot

## Example Task: TDDUI Task Transport Example

Profile: [TDDUI Task Transport](StructureDefinition-tddui-task-transport.md)
