...
| | |
| :--- | :--- |
| *Official URL*:https://interop.esante.gouv.fr/ig/fhir/tddui/CapabilityStatement/TDDUIConsommateur | *Version*:2.3.0-ballot |
...
```json
{
  ...
  "rest" : [{
    ...
    {
      "type" : "Basic",
      "supportedProfile" : ["https://interop.esante.gouv.fr/ig/fhir/tddui/StructureDefinition/tddui-basic-droit-decision"],
      "interaction" : [{
        "code" : "create"
      }]
    }],
