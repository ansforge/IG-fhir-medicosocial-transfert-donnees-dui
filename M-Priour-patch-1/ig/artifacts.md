...
| [TDDUI Goal Projet Vie](StructureDefinition-tddui-goal-projet-vie.md) | Profil de la ressource Goal permettant de représenter le projet de vie de l'usager. |
...
| [TDDUI Goal Identifier Projet Vie](ValueSet-tddui-goal-Identifier-projet-vie.md) | ValueSet définissant les types de notes pour l'élément Goal.note. |
...
| [TDDUI Goal Identifier](CodeSystem-tddui-goal-identifier.md) | CodeSystem pour la défintion des identifiants de la ressource Goal |
