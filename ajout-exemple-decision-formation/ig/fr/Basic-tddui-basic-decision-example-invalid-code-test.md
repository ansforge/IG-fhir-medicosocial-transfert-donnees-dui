# TDDUI Basic Decision Example Invalid Code Test - Médicosocial - Transfert de données DUI v2.4.0-ballot

## Exemple Basic: TDDUI Basic Decision Example Invalid Code Test
...
**value**: 2020-01-01**categorieDroitPrestation**: Orientation scolaire**typeDroitPrestation**: Orientation vers un Service d'éducation spéciale et de soins à domicile (SESSAD)**natureDroitPrestation**: 99**dateOuverture**: 2020-01-01**dateEcheance**: 2020-12-31**existencePAG**: false
> **detailPrestation**
* qualificationOrientation: Cible
* formation: Formation pour la prestation
...
**identifier**: Identifiant principal de la décision/1254 (utilisation : official, ), Identifiant révisé de la décision/1255
...
{
  "resourceType" : "Basic",
  "id" : "tddui-basic-decision-example-invalid-code-test",
  "meta" : {
