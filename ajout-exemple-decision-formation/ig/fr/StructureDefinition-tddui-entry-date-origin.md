# TDDUI Entry Date Origin - Médicosocial - Transfert de données DUI v2.4.0
...
Autres représentations du profil : [CSV](../StructureDefinition-tddui-entry-date-origin.csv), [Excel](../StructureDefinition-tddui-entry-date-origin.xlsx), [Schematron](../StructureDefinition-tddui-entry-date-origin.sch) 
