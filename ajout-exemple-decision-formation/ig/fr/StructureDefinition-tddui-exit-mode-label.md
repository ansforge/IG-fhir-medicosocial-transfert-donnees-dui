# TDDUI Exit Mode Label - Médicosocial - Transfert de données DUI v2.4.0
...
Extension simple avec le type string : Libellé du mode de sortie du séjour.
...
Autres représentations du profil : [CSV](../StructureDefinition-tddui-exit-mode-label.csv), [Excel](../StructureDefinition-tddui-exit-mode-label.xlsx), [Schematron](../StructureDefinition-tddui-exit-mode-label.sch) 
