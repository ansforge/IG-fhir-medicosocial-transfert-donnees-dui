# Description - Médicosocial - Transfert de données DUI v2.4.0
...
Extension simple avec le type string : Description du contact PersonnePhysique.
...
Autres représentations du profil : [CSV](../StructureDefinition-tddui-related-person-contact-description.csv), [Excel](../StructureDefinition-tddui-related-person-contact-description.xlsx), [Schematron](../StructureDefinition-tddui-related-person-contact-description.sch) 
