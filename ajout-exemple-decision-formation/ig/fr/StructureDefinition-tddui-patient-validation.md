# TDDUI Patient Validation - Médicosocial - Transfert de données DUI v2.4.0
...
Extension simple avec le type boolean : Validation par l'usager que l'événement a eu lieu.
...
Autres représentations du profil : [CSV](../StructureDefinition-tddui-patient-validation.csv), [Excel](../StructureDefinition-tddui-patient-validation.xlsx), [Schematron](../StructureDefinition-tddui-patient-validation.sch) 
