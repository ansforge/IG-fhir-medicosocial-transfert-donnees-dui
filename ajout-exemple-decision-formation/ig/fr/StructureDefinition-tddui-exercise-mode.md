...
Extension simple avec le type CodeableConcept : Extension permettant de représenter le mode d'exercice du professionnel.
...
Autres représentations du profil : [CSV](../StructureDefinition-tddui-exercise-mode.csv), [Excel](../StructureDefinition-tddui-exercise-mode.xlsx), [Schematron](../StructureDefinition-tddui-exercise-mode.sch) 
