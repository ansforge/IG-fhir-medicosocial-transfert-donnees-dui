# tddui-task-action-1-educ-ime-example - Médicosocial - Transfert de données DUI v2.1.0-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **tddui-task-action-1-educ-ime-example**

## Example Task: tddui-task-action-1-educ-ime-example
...
{
  "resourceType" : "Task",
  "id" : "tddui-task-action-1-educ-ime-example",
  "meta" : {
    "profile" : [
