# tddui-task-action-2-as-pa-example - Médicosocial - Transfert de données DUI v2.1.0-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **tddui-task-action-2-as-pa-example**

## Example Task: tddui-task-action-2-as-pa-example

Profil: [TDDUI Task Action](StructureDefinition-tddui-task-action.md)

**identifier**: `https://identifiant-medicosocial-action.esante.gouv.fr`/3480787529/123456789-ACTI-1239
...
**description**: Accompagner les premiers déplacements

**owner**: AS

> **input****type**:Titre de l'action à mener.**value**: Action de l'AS pour atteindre l'objectif 1
...
{
  "resourceType" : "Task",
  "id" : "tddui-task-action-2-as-pa-example",
  "meta" : {
    "profile" : [
  ...
  "identifier" : [
    {
      ...
      "value" : "3480787529/123456789-ACTI-1239"
    }
  ],
  "basedOn" : [
    {
