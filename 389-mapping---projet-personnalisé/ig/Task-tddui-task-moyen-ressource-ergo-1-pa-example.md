# tddui-task-moyen-ressource-ergo-1-pa-example - Médicosocial - Transfert de données DUI v2.1.0-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **tddui-task-moyen-ressource-ergo-1-pa-example**

## Example Task: tddui-task-moyen-ressource-ergo-1-pa-example
...
**partOf**: [Task : identifier = https://identifiant-medicosocial-action.esante.gouv.fr#3480787529/123456789-ACTI-1235; status = in-progress; intent = plan; description = Évaluer et aménagr la chambre (éclairage, barres, tapis)](Task-tddui-task-action-1-ergo-pa-example.md)
...
{
  "resourceType" : "Task",
  "id" : "tddui-task-moyen-ressource-ergo-1-pa-example",
  "meta" : {
    "profile" : [
