...
| [Goal](http://hl7.org/fhir/StructureDefinition/Goal) | [TDDUIGoalAttente](StructureDefinition-tddui-goal-attente.md) | Profil de la ressource TDDUIGoal permettant de représenter les attentes de l'usager. |
| [Goal](http://hl7.org/fhir/StructureDefinition/Goal) | [TDDUIGoalObjectif](StructureDefinition-tddui-goal-objectif.md) | Profil de la ressource TDDUIGoalObjectif permettant de représenter les résultats à atteindre dans le cadre du projet personnalisé. |
  ...
  "definition" : {
    ...
    "resource" : [
      ...
      },
      {
        ...
        "name" : "tddui-servicerequest-besoin-pa-example",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "Task/tddui-task-action-1-pa-example"
        },
        "name" : "tddui-task-action-1-pa-example",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "Task/tddui-task-action-2-pa-example"
        },
        "name" : "tddui-task-action-2-pa-example",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "Task/tddui-task-action-3-pa-example"
        },
        "name" : "tddui-task-action-3-pa-example",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "Task/tddui-task-moyen-ressource-pa-example"
        },
        "name" : "tddui-task-moyen-ressource-pa-example",
