# tddui-task-action-2-kine-pa-example - Médicosocial - Transfert de données DUI v2.1.0-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **tddui-task-action-2-kine-pa-example**

## Example Task: tddui-task-action-2-kine-pa-example

Profil: [TDDUI Task Action](StructureDefinition-tddui-task-action.md)

**identifier**: `https://identifiant-medicosocial-action.esante.gouv.fr`/3480787529/123456789-ACTI-12343
...
{
  "resourceType" : "Task",
  "id" : "tddui-task-action-2-kine-pa-example",
  "meta" : {
    "profile" : [
  ...
  "identifier" : [
    {
      ...
      "value" : "3480787529/123456789-ACTI-12343"
    }
  ],
  "basedOn" : [
    {
