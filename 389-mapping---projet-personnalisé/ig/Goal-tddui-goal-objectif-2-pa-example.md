# tddui-goal-objectif-2-pa-example - Médicosocial - Transfert de données DUI v2.1.0-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **tddui-goal-objectif-2-pa-example**

## Example Goal: tddui-goal-objectif-2-pa-example
...
**addresses**: [ServiceRequest](ServiceRequest-tddui-servicerequest-besoin-2-pa-example.md)
...
{
  "resourceType" : "Goal",
  "id" : "tddui-goal-objectif-2-pa-example",
  "meta" : {
    "profile" : [
