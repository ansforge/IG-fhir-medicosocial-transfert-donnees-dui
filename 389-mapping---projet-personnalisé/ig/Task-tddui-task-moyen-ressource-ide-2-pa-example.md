# tddui-task-moyen-ressource-ide-2-pa-example - Médicosocial - Transfert de données DUI v2.1.0-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **tddui-task-moyen-ressource-ide-2-pa-example**

## Example Task: tddui-task-moyen-ressource-ide-2-pa-example
...
**partOf**: [Task : identifier = https://identifiant-medicosocial-action.esante.gouv.fr#3480787529/123456789-ACTI-12342; status = in-progress; intent = plan; description = Pesée mensuelle et dépistage dénutrition](Task-tddui-task-action-2-ide-pa-example.md)
...
{
  "resourceType" : "Task",
  "id" : "tddui-task-moyen-ressource-ide-2-pa-example",
  "meta" : {
    "profile" : [
