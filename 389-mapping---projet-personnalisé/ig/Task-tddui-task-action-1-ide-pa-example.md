# tddui-task-action-1-ide-pa-example - Médicosocial - Transfert de données DUI v2.1.0-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **tddui-task-action-1-ide-pa-example**

## Example Task: tddui-task-action-1-ide-pa-example
...
{
  "resourceType" : "Task",
  "id" : "tddui-task-action-1-ide-pa-example",
  "meta" : {
    "profile" : [
