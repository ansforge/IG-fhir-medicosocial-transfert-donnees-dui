# tddui-task-action-1-as-pa-example - Médicosocial - Transfert de données DUI v2.1.0-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **tddui-task-action-1-as-pa-example**

## Example Task: tddui-task-action-1-as-pa-example
...
{
  "resourceType" : "Task",
  "id" : "tddui-task-action-1-as-pa-example",
  "meta" : {
    "profile" : [
