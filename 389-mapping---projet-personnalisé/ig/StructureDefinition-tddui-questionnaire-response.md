...
| Active as of 2025-11-18 | *Computable Name*:TDDUIQuestionnaireResponse |
...
* Refer to this Profile: [Lien vers l'évaluation](StructureDefinition-tddui-evaluation-reference.md), [TDDUI Task Action](StructureDefinition-tddui-task-action.md) and [TDDUI Task MoyenRessource](StructureDefinition-tddui-task-moyen-ressource.md)
