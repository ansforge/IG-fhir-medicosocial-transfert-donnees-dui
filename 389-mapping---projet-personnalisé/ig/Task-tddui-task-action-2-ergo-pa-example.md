# tddui-task-action-2-ergo-pa-example - Médicosocial - Transfert de données DUI v2.1.0-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **tddui-task-action-2-ergo-pa-example**

## Example Task: tddui-task-action-2-ergo-pa-example
...
**description**: Former à l'utilisation des aides techniques
...
{
  "resourceType" : "Task",
  "id" : "tddui-task-action-2-ergo-pa-example",
  "meta" : {
    "profile" : [
