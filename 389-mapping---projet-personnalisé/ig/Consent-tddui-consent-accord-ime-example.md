# tddui-consent-accord-ime-example - Médicosocial - Transfert de données DUI v2.1.0-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **tddui-consent-accord-ime-example**

## Example Consent: tddui-consent-accord-ime-example
...
```json
{
  ...
  "id" : "tddui-consent-accord-ime-example",
  "meta" : {
    "profile" : [
