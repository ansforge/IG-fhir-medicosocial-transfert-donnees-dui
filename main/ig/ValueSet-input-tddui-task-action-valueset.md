# InputTDDUITaskActionValueSet - Médicosocial - Transfert de données DUI v2.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **InputTDDUITaskActionValueSet**

## ValueSet: InputTDDUITaskActionValueSet 

| | |
| :--- | :--- |
| *Official URL*:https://interop.esante.gouv.fr/ig/fhir/tddui/ValueSet/input-tddui-task-action-valueset | *Version*:2.1.0 |
| Active as of 2025-12-19 | *Computable Name*:InputTDDUITaskActionValueSet |
...
```json
{
  ...
  "id" : "input-tddui-task-action-valueset",
  "meta" : {
    "profile" : ["http://hl7.org/fhir/StructureDefinition/shareablevalueset"]
  },
  "url" : "https://interop.esante.gouv.fr/ig/fhir/tddui/ValueSet/input-tddui-task-action-valueset",
  "version" : "2.1.0",
