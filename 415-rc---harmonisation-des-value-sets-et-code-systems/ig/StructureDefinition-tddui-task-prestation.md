...
| Active as of 2026-02-04 | *Computable Name*:TDDUITaskPrestation |
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "binding" : {
          "strength" : "required",
          "valueSet" : "https://interop.esante.gouv.fr/ig/fhir/tddui/ValueSet/tddui-task-input-prestation|2.2.0-ballot"
        }
      },
      {
        "id" : "Task.input:titre",
