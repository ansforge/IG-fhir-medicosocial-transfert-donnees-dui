...
## ValueSet: OutputTDDUITaskBilan 

| | |
| :--- | :--- |
| *Official URL*:https://interop.esante.gouv.fr/ig/fhir/tddui/ValueSet/output-tddui-task-bilan | *Version*:2.2.0-ballot |
...
```json
{
  ...
  "url" : "https://interop.esante.gouv.fr/ig/fhir/tddui/ValueSet/output-tddui-task-bilan",
