...
## ValueSet: InputTDDUITaskPrestation 

| | |
| :--- | :--- |
| *Official URL*:https://interop.esante.gouv.fr/ig/fhir/tddui/ValueSet/input-tddui-task-prestation | *Version*:2.2.0-ballot |
...
```json
{
  ...
  "url" : "https://interop.esante.gouv.fr/ig/fhir/tddui/ValueSet/input-tddui-task-prestation",
