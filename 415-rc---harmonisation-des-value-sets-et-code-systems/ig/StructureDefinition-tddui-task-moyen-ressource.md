...
| Active as of 2026-01-28 | *Computable Name*:TDDUITaskMoyenRessource |
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "binding" : {
          "strength" : "required",
          "valueSet" : "https://interop.esante.gouv.fr/ig/fhir/tddui/ValueSet/input-tddui-task-moyen-ressource|2.2.0-ballot"
        }
      },
      {
        "id" : "Task.input:titre",
