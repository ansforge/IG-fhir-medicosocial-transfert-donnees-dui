# TDDUI Goal Objectif Note - Médicosocial - Transfert de données DUI v2.2.0-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **TDDUI Goal Objectif Note**

## ValueSet: TDDUI Goal Objectif Note 

| | |
| :--- | :--- |
| *Official URL*:https://interop.esante.gouv.fr/ig/fhir/tddui/ValueSet/tddui-goal-objectif-note | *Version*:2.2.0-ballot |
| Active as of 2026-02-04 | *Computable Name*:TDDUIGoalObjectifNote |
...
```json
{
  ...
  "compose" : {
    "include" : [
      {
        "valueSet" : [
          "https://interop.esante.gouv.fr/ig/fhir/tddui/ValueSet/tddui-discriminator|2.2.0-ballot"
        ]
      }
    ],
    "exclude" : [
