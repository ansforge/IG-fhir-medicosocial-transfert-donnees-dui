...
| Active as of 2026-02-26 | *Computable Name*:TDDUIPatient |
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://interop.esante.gouv.fr/ig/fhir/tddui/StructureDefinition/tddui-birth-order|2.2.0-ballot"]
      }],
      "mapping" : [{
        "identity" : "specmetier-to-TDDUIPatient",
