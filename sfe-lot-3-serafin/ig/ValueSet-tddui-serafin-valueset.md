...
| Active as of 2026-02-23 | *Computable Name*:TDDUISerafinValueSet |
...
```json
{
  ...
  "compose" : {
    "include" : [{
      "valueSet" : ["https://mos.esante.gouv.fr/NOS/JDV_J283-PrestationsIndirects_SERAFIN/FHIR/JDV-J283-PrestationsIndirects-SERAFIN|20241025120000",
