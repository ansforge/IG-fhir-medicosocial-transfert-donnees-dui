# TDDUI Event Report - Médicosocial - Transfert de données DUI v2.4.0-ballot
...
Extension simple avec le type string : Zone de texte liée à l’événement pour compte rendu des actions réalisées.
...
Autres représentations du profil : [CSV](../StructureDefinition-tddui-event-report.csv), [Excel](../StructureDefinition-tddui-event-report.xlsx), [Schematron](../StructureDefinition-tddui-event-report.sch) 
