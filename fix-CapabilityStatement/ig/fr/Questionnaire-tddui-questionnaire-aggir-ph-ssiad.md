# Évaluation AGGIR PH SSIAD - Médicosocial - Transfert de données DUI v2.4.0-ballot
...
* [Grille de réponse AGGIR PH](QuestionnaireResponse-tddui-questionnaire-response-aggir-ph-example.md)
