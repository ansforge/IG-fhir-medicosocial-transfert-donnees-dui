# Évaluation AGGIR PA SSIAD - Médicosocial - Transfert de données DUI v2.4.0-ballot
...
* [Grille de réponse AGGIR PA](QuestionnaireResponse-tddui-pp-pa-questionnaire-response-aggir-pa-example.md)
* [Grille de réponse AGGIR PA](QuestionnaireResponse-tddui-questionnaire-response-aggir-pa-example.md)
