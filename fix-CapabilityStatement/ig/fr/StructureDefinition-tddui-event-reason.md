# TDDUI Event Reason - Médicosocial - Transfert de données DUI v2.4.0-ballot
...
Extension simple avec le type string : Contexte justifiant la réalisation de l’évènement.
...
Autres représentations du profil : [CSV](../StructureDefinition-tddui-event-reason.csv), [Excel](../StructureDefinition-tddui-event-reason.xlsx), [Schematron](../StructureDefinition-tddui-event-reason.sch) 
