# Évaluation SERAFIN - Médicosocial - Transfert de données DUI v2.4.0-ballot
...
* [Evaluation SERAFIN pour un besoin d'hébergement adapté avec précision](QuestionnaireResponse-tddui-questionnaire-response-serafin-precision-example.md)
* [Evaluation SERAFIN pour un besoin d'hébergement adapté sans précision](QuestionnaireResponse-tddui-questionnaire-response-serafin-sans-precision-example.md)
