...
* [https://interop.esante.gouv.fr/ig/fhir/tddui/StructureDefinition/tddui-entry-date-origin](StructureDefinition-tddui-entry-date-origin.md)
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://hl7.org/fhir/5.0/StructureDefinition/extension-Encounter.plannedStartDate"]
      }],
      "mapping" : [{
        "identity" : "specmetier-to-TDDUIEncounterSejour",
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://hl7.org/fhir/5.0/StructureDefinition/extension-Encounter.plannedEndDate"]
      }],
      "mapping" : [{
        "identity" : "specmetier-to-TDDUIEncounterSejour",
