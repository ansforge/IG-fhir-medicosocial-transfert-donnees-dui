...
* [https://interop.esante.gouv.fr/ig/fhir/tddui/StructureDefinition/tddui-birth-order|2.4.0-ballot](StructureDefinition-tddui-birth-order.md)
...
Autres représentations du profil : [CSV](../StructureDefinition-tddui-patient.csv), [Excel](../StructureDefinition-tddui-patient.xlsx), [Schematron](../StructureDefinition-tddui-patient.sch) 
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://interop.esante.gouv.fr/ig/fhir/tddui/StructureDefinition/tddui-birth-order|2.4.0-ballot"]
      }],
      "mapping" : [{
        "identity" : "specmetier-to-TDDUIPatient",
