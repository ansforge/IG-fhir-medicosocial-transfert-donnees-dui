# TDDUI CarePlan Projet Personalise - Médicosocial - Transfert de données DUI v2.4.0-ballot

## Profil de ressource: TDDUI CarePlan Projet Personalise 
...
Autres représentations du profil : [CSV](../StructureDefinition-tddui-careplan-projet-personnalise.csv), [Excel](../StructureDefinition-tddui-careplan-projet-personnalise.xlsx), [Schematron](../StructureDefinition-tddui-careplan-projet-personnalise.sch) 
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["https://interop.esante.gouv.fr/ig/fhir/tddui/StructureDefinition/tddui-consent-accord|2.4.0-ballot"]
      }],
      "mapping" : [{
        "identity" : "specmetier-to-TDDUICarePlanProjetPersonnalise",
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "https://interop.esante.gouv.fr/ig/fhir/tddui/ValueSet/tddui-care-plan-supporting-info|2.4.0-ballot"
      }
    },
    {
