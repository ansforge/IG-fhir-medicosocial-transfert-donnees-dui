# TDDUI Event Cancel Reason - Médicosocial - Transfert de données DUI v2.4.0-ballot
...
Extension simple avec le type CodeableConcept : Motif associé au statut de non-réalisation de l’évènement.
...
Autres représentations du profil : [CSV](../StructureDefinition-tddui-event-cancel-reason.csv), [Excel](../StructureDefinition-tddui-event-cancel-reason.xlsx), [Schematron](../StructureDefinition-tddui-event-cancel-reason.sch) 
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "https://smt.esante.gouv.fr/fhir/ValueSet/jdv-motif-non-realisation-evenement-cisis|20260619134042"
      }
    }]
  }
}
