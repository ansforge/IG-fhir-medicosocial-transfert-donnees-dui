...
* [https://interop.esante.gouv.fr/ig/fhir/tddui/StructureDefinition/tddui-planned-absence|2.4.0-ballot](StructureDefinition-tddui-planned-absence.md)
* [https://interop.esante.gouv.fr/ig/fhir/tddui/StructureDefinition/tddui-facturation|2.4.0-ballot](StructureDefinition-tddui-facturation.md)
...
```json
{
  ...
  "abstract" : false,
  "type" : "Slot",
  "baseDefinition" : "https://hl7.fr/ig/fhir/core/StructureDefinition/fr-core-slot|2.1.0",
  ...
  "differential" : {
    "element" : [{
      ...
      "constraint" : [{
        ...
        "source" : "https://interop.esante.gouv.fr/ig/fhir/tddui/StructureDefinition/tddui-slot-presence-absence|2.4.0-ballot"
      },
      {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://interop.esante.gouv.fr/ig/fhir/tddui/StructureDefinition/tddui-planned-absence|2.4.0-ballot"]
      }],
      "mapping" : [{
        "identity" : "specmetier-to-TDDUISlotPresenceAbsence",
        "map" : "absencePrevue"
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://interop.esante.gouv.fr/ig/fhir/tddui/StructureDefinition/tddui-facturation|2.4.0-ballot"]
      }],
      "mapping" : [{
        "identity" : "specmetier-to-TDDUISlotPresenceAbsence",
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "https://interop.esante.gouv.fr/ig/fhir/tddui/ValueSet/tddui-slot-identifier-presence-absence|2.4.0-ballot"
      }
    },
    {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "https://smt.esante.gouv.fr/fhir/ValueSet/jdv-j405-type-presence-absence-ms|20260505120000"
      },
      "mapping" : [{
        "identity" : "specmetier-to-TDDUISlotPresenceAbsence",
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "https://smt.esante.gouv.fr/fhir/ValueSet/jdv-j406-motif-absence-ms|20260505120000"
      },
      "mapping" : [{
        "identity" : "specmetier-to-TDDUISlotPresenceAbsence",
        "map" : "motifAbsence"
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["https://interop.esante.gouv.fr/ig/fhir/tddui/StructureDefinition/tddui-schedule|2.4.0-ballot"]
      }]
    },
    {
      "id" : "Slot.status",
