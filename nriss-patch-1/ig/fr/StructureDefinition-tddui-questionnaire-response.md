...
## Profil de ressource: TDDUI QuestionnaireResponse 
...
Cette structure est dérivée de [QuestionnaireResponse](http://hl7.org/fhir/R4/questionnaireresponse.html) 
...
* [https://interop.esante.gouv.fr/ig/fhir/tddui/StructureDefinition/tddui-qr-participant|2.4.0-ballot](StructureDefinition-tddui-qr-participant.md)
...
* [https://interop.esante.gouv.fr/ig/fhir/tddui/StructureDefinition/tddui-assessment-method|2.4.0-ballot](StructureDefinition-tddui-assessment-method.md)
...
Autres représentations du profil : [CSV](../StructureDefinition-tddui-questionnaire-response.csv), [Excel](../StructureDefinition-tddui-questionnaire-response.xlsx), [Schematron](../StructureDefinition-tddui-questionnaire-response.sch) 
  ...
  "differential" : {
    "element" : [{
      ...
      "constraint" : [{
        ...
        "source" : "https://interop.esante.gouv.fr/ig/fhir/tddui/StructureDefinition/tddui-questionnaire-response|2.4.0-ballot"
      },
      {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://interop.esante.gouv.fr/ig/fhir/tddui/StructureDefinition/tddui-qr-participant|2.4.0-ballot"]
      }]
    },
    {
    ...
    {
      "id" : "QuestionnaireResponse.extension:TDDUIAssessmentMethod",
      "path" : "QuestionnaireResponse.extension",
      "sliceName" : "TDDUIAssessmentMethod",
      "min" : 0,
      "max" : "1",
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://interop.esante.gouv.fr/ig/fhir/tddui/StructureDefinition/tddui-assessment-method|2.4.0-ballot"]
      }],
      "mapping" : [{
        "identity" : "specmetier-to-TDDUIQuestionnaireResponseAGGIR",
    ...
    {
      "id" : "QuestionnaireResponse.status.extension",
      "path" : "QuestionnaireResponse.status.extension",
      "slicing" : {
        "discriminator" : [{
          "type" : "value",
          "path" : "url"
    ...
    {
      "id" : "QuestionnaireResponse.status.extension:TDDUIStatusAuthor",
      "path" : "QuestionnaireResponse.status.extension",
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["https://interop.esante.gouv.fr/ig/fhir/tddui/StructureDefinition/tddui-encounter-evenement|2.4.0-ballot"]
      }],
      "mapping" : [{
        "identity" : "specmetier-to-TDDUIQuestionnaireResponseAGGIR",
        "map" : "Evenement"
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["https://interop.esante.gouv.fr/ig/fhir/tddui/StructureDefinition/tddui-practitioner|2.4.0-ballot",
        "https://interop.esante.gouv.fr/ig/fhir/tddui/StructureDefinition/tddui-patient|2.4.0-ballot",
        "https://interop.esante.gouv.fr/ig/fhir/tddui/StructureDefinition/tddui-patient-ins|2.4.0-ballot"]
      }],
      "mapping" : [{
        "identity" : "specmetier-to-TDDUIQuestionnaireResponseAGGIR",
