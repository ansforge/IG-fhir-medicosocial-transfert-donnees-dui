# TDDUI Goal Attente - Médicosocial - Transfert de données DUI v2.4.0-ballot

## Profil de ressource: TDDUI Goal Attente 
...
Autres représentations du profil : [CSV](../StructureDefinition-tddui-goal-attente.csv), [Excel](../StructureDefinition-tddui-goal-attente.xlsx), [Schematron](../StructureDefinition-tddui-goal-attente.sch) 
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "https://interop.esante.gouv.fr/ig/fhir/tddui/ValueSet/tddui-goal-attente-note|2.4.0-ballot"
      }
    },
    {
