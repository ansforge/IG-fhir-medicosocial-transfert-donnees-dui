...
Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.fhir.fr.tddui|current/StructureDefinition/tddui-task-moyen-ressource)
...
Autres représentations du profil : [CSV](../StructureDefinition-tddui-task-moyen-ressource.csv), [Excel](../StructureDefinition-tddui-task-moyen-ressource.xlsx), [Schematron](../StructureDefinition-tddui-task-moyen-ressource.sch) 
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["https://interop.esante.gouv.fr/ig/fhir/tddui/StructureDefinition/tddui-task-action|2.4.0-ballot"]
      }],
      "mapping" : [{
        "identity" : "specmetier-to-TDDUITaskMoyenRessource",
        "map" : "Action"
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "https://interop.esante.gouv.fr/ig/fhir/tddui/ValueSet/tddui-task-input-moyen-ressource|2.4.0-ballot"
      }
    },
    {
      "id" : "Task.input:titre",
