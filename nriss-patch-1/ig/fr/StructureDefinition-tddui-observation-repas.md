...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "https://interop.esante.gouv.fr/ig/fhir/tddui/ValueSet/tddui-observation-identifier-repas|2.4.0-ballot"
      }
    },
    {
      ...
      "constraint" : [{
        ...
        "source" : "https://interop.esante.gouv.fr/ig/fhir/tddui/StructureDefinition/tddui-observation-repas|2.4.0-ballot"
      }],
      "mapping" : [{
        "identity" : "specmetier-to-TDDUIObservationRepas",
        "map" : "idRepas"
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "https://smt.esante.gouv.fr/fhir/ValueSet/jdv-j407-type-repas-ms|20260505120000"
      },
      "mapping" : [{
        "identity" : "specmetier-to-TDDUIObservationRepas",
        "map" : "typeRepas"
