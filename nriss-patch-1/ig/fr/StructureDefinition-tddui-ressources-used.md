...
Extension complexe: Ressources utilisées lors de l’évènement (ex : chambre, matériel médical, véhicule).
...
Autres représentations du profil : [CSV](../StructureDefinition-tddui-ressources-used.csv), [Excel](../StructureDefinition-tddui-ressources-used.xlsx), [Schematron](../StructureDefinition-tddui-ressources-used.sch) 
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "https://smt.esante.gouv.fr/fhir/ValueSet/jdv-ressource-utilisee-cisis|20260619134042"
      }
    },
    {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "https://smt.esante.gouv.fr/fhir/ValueSet/jdv-detail-materiel-specialise-cisis|20260619134042"
      }
    },
    {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "https://smt.esante.gouv.fr/fhir/ValueSet/jdv-detail-ressource-immobiliere-utilisee-cisis|20260619134042"
      }
    },
    {
      "id" : "Extension.url",
