...
Autres représentations du profil : [CSV](../StructureDefinition-tddui-task-transport-usager.csv), [Excel](../StructureDefinition-tddui-task-transport-usager.xlsx), [Schematron](../StructureDefinition-tddui-task-transport-usager.sch) 
