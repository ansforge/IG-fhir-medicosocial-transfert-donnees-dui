...
* [https://interop.esante.gouv.fr/ig/fhir/tddui/StructureDefinition/tddui-nationality|2.4.0-ballot](StructureDefinition-tddui-nationality.md)
...
* [https://interop.esante.gouv.fr/ig/fhir/tddui/StructureDefinition/tddui-related-person-contact-description|2.4.0-ballot](StructureDefinition-tddui-related-person-contact-description.md)
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://interop.esante.gouv.fr/ig/fhir/tddui/StructureDefinition/tddui-nationality|2.4.0-ballot"]
      }],
      "mapping" : [{
        "identity" : "specmetier-to-TDDUIRelatedPersonContact",
        "map" : "paysNationalite"
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://interop.esante.gouv.fr/ig/fhir/tddui/StructureDefinition/tddui-related-person-contact-description|2.4.0-ballot"]
      }],
      "mapping" : [{
        "identity" : "specmetier-to-TDDUIRelatedPersonContact",
        "map" : "description"
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "https://interop.esante.gouv.fr/ig/fhir/tddui/ValueSet/tddui-contact-related-person-relashionship|2.4.0-ballot"
      }
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "https://smt.esante.gouv.fr/fhir/ValueSet/jdv-j384-role-membre-famille-ms|20260202120000"
      },
      "mapping" : [{
        "identity" : "specmetier-to-TDDUIRelatedPersonContact",
        "map" : "role"
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "https://interop.esante.gouv.fr/ig/fhir/tddui/ValueSet/tddui-contact-relation|2.4.0-ballot"
      },
      "mapping" : [{
        "identity" : "specmetier-to-TDDUIRelatedPersonContact",
        "map" : "relation"
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "https://interop.esante.gouv.fr/ig/fhir/tddui/ValueSet/tddui-contact-protection-juridique|2.4.0-ballot"
      },
      "mapping" : [{
        "identity" : "specmetier-to-TDDUIRelatedPersonContact",
        "map" : "relation"
