# TDDUI Encounter Sejour - Médicosocial - Transfert de données DUI v2.4.0-ballot

## Profil de ressource: TDDUI Encounter Sejour 
...
* [http://hl7.org/fhir/5.0/StructureDefinition/extension-Encounter.plannedStartDate|0.1.0](http://hl7.org/fhir/uv/xver-r5.r4/0.1.0/StructureDefinition-ext-R5-Encounter.plannedStartDate.html)
* [http://hl7.org/fhir/5.0/StructureDefinition/extension-Encounter.plannedEndDate|0.1.0](http://hl7.org/fhir/uv/xver-r5.r4/0.1.0/StructureDefinition-ext-R5-Encounter.plannedEndDate.html)
* [https://interop.esante.gouv.fr/ig/fhir/tddui/StructureDefinition/tddui-admission-date|2.4.0-ballot](StructureDefinition-tddui-admission-date.md)
* [https://interop.esante.gouv.fr/ig/fhir/tddui/StructureDefinition/tddui-entry-mode-label|2.4.0-ballot](StructureDefinition-tddui-entry-mode-label.md)
* [https://interop.esante.gouv.fr/ig/fhir/tddui/StructureDefinition/tddui-exit-mode-label|2.4.0-ballot](StructureDefinition-tddui-exit-mode-label.md)
...
* [https://interop.esante.gouv.fr/ig/fhir/tddui/StructureDefinition/tddui-entry-date-origin|2.4.0-ballot](StructureDefinition-tddui-entry-date-origin.md)
...
Autres représentations du profil : [CSV](../StructureDefinition-tddui-encounter-sejour.csv), [Excel](../StructureDefinition-tddui-encounter-sejour.xlsx), [Schematron](../StructureDefinition-tddui-encounter-sejour.sch) 
...
```json
{
  ...
  "differential" : {
    ...
    {
      "id" : "Encounter.extension:TDDUI-plannedStartDate-r5.extension",
    ...
    {
      "id" : "Encounter.extension:TDDUI-plannedEndDate-r5.extension",
      "path" : "Encounter.extension.extension",
      "max" : "0"
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://interop.esante.gouv.fr/ig/fhir/tddui/StructureDefinition/tddui-admission-date|2.4.0-ballot"]
      }],
      "mapping" : [{
        "identity" : "specmetier-to-TDDUIEncounterSejour",
        "map" : "dateAdmission"
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://interop.esante.gouv.fr/ig/fhir/tddui/StructureDefinition/tddui-entry-mode-label|2.4.0-ballot"]
      }],
      "mapping" : [{
        "identity" : "specmetier-to-TDDUIEncounterSejour",
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://interop.esante.gouv.fr/ig/fhir/tddui/StructureDefinition/tddui-exit-mode-label|2.4.0-ballot"]
      }],
      "mapping" : [{
        "identity" : "specmetier-to-TDDUIEncounterSejour",
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "https://interop.esante.gouv.fr/ig/fhir/tddui/ValueSet/tddui-encounter-identifier|2.4.0-ballot"
      }
    },
    {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "https://mos.esante.gouv.fr/NOS/JDV_J226-ModaliteAccueil-ROR/FHIR/JDV-J226-ModaliteAccueil-ROR|20260629120000"
      },
      "mapping" : [{
        "identity" : "specmetier-to-TDDUIEncounterSejour",
        "map" : "modaliteAccueil"
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://interop.esante.gouv.fr/ig/fhir/tddui/StructureDefinition/tddui-entry-date-origin|2.4.0-ballot"]
      }],
      "mapping" : [{
        "identity" : "specmetier-to-TDDUIEncounterSejour",
