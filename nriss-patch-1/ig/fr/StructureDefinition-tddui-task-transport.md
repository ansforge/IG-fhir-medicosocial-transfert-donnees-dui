# TDDUI Task Transport - Médicosocial - Transfert de données DUI v2.4.0-ballot

## Profil de ressource: TDDUI Task Transport 
...
Autres représentations du profil : [CSV](../StructureDefinition-tddui-task-transport.csv), [Excel](../StructureDefinition-tddui-task-transport.xlsx), [Schematron](../StructureDefinition-tddui-task-transport.sch) 
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "https://interop.esante.gouv.fr/ig/fhir/tddui/ValueSet/tddui-task-input-transport|2.4.0-ballot"
      }
    },
    {
