...
* The element 1 is sliced based on the value of Task.input.value[x].author[x]
...
Autres représentations du profil : [CSV](../StructureDefinition-tddui-task-bilan.csv), [Excel](../StructureDefinition-tddui-task-bilan.xlsx), [Schematron](../StructureDefinition-tddui-task-bilan.sch) 
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "https://interop.esante.gouv.fr/ig/fhir/tddui/ValueSet/tddui-task-input-bilan|2.4.0-ballot"
      }
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        ...
        "https://interop.esante.gouv.fr/ig/fhir/tddui/StructureDefinition/tddui-related-person-contact|2.4.0-ballot"]
      }],
      "mapping" : [{
        "identity" : "specmetier-to-TDDUITaskBilan",
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "https://interop.esante.gouv.fr/ig/fhir/tddui/ValueSet/tddui-task-output-bilan|2.4.0-ballot"
      }
    },
    {
