# TDDUI Observation Mobilite Usager - Médicosocial - Transfert de données DUI v2.4.0-ballot
...
* Examples for this Profile: [Observation/tddui-observation-mobilite-usager-example](Observation-tddui-observation-mobilite-usager-example.md)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ans.fhir.fr.tddui|current/StructureDefinition/StructureDefinition-tddui-observation-mobilite-usager.json)
