...
| [Basic](http://hl7.org/fhir/StructureDefinition/Basic|4.0.1) | [TDDUIBasicDecision](StructureDefinition-tddui-basic-decision.md) | Profil de la ressource Basic permettant de représenter la décision de la CDAPH ainsi que les droits associés. |
...
| [Goal](http://hl7.org/fhir/StructureDefinition/Goal|4.0.1) | [TDDUIGoalProjetVie](StructureDefinition-tddui-goal-projet-vie.md) | Profil de la ressource Goal permettant de représenter le projet de vie de l'usager. |
| [Observation](http://hl7.org/fhir/StructureDefinition/Observation|4.0.1) | [TDDUIObservationCauseMortalite](StructureDefinition-tddui-observation-cause-mortalite.md) | Profil de la ressource Observation permettant de représenter les causes de mortalité d'un usager. |
| [Observation](http://hl7.org/fhir/StructureDefinition/Observation|4.0.1) | [TDDUIObservationMobiliteUsager](StructureDefinition-tddui-observation-mobilite-usager.md) | Profil de la ressource Observation permettant de représenter la mobilité de l'usager. |
...
| [Observation](http://hl7.org/fhir/StructureDefinition/Observation|4.0.1) | [TDDUIObservationRepas](StructureDefinition-tddui-observation-repas.md) | Profil de la ressource Observation permettant de représenter si l'usager bénéficie ou non des repas. |
...
| [FR Core Schedule Profile](https://hl7.fr/ig/fhir/core/StructureDefinition/fr-core-schedule|2.1.0) | [TDDUISchedule](StructureDefinition-tddui-schedule.md) | Profil de la ressource FRCoreScheduleProfile permettant de contenir l'ensemble des présences et absences de l'usager. |
...
| [ServiceRequest](http://hl7.org/fhir/StructureDefinition/ServiceRequest|4.0.1) | [TDDUIServiceRequestDemandeOrientation](StructureDefinition-tddui-service-request-demande-orientation.md) | Profil de la ressource ServiceRequest permettant de représenter la demande d'orientation adressée à la CDAPH. |
| [FR Core Slot Profile](https://hl7.fr/ig/fhir/core/StructureDefinition/fr-core-slot|2.1.0) | [TDDUISlotPresenceAbsence](StructureDefinition-tddui-slot-presence-absence.md) | Profil de la ressource FRCoreSlotProfile permettant de représenter les présences et absences de l'usager. |
...
| [TDDUI Task Transport](https://interop.esante.gouv.fr/ig/fhir/tddui/StructureDefinition/tddui-task-transport|2.4.0-ballot) | [TDDUITaskTransportProfessionnel](StructureDefinition-tddui-task-transport-professionnel.md) | Profil de la ressource TDDUITaskTransport permettant de représenter le transport du professionnel. |
| [TDDUI Task Transport](https://interop.esante.gouv.fr/ig/fhir/tddui/StructureDefinition/tddui-task-transport|2.4.0-ballot) | [TDDUITaskTransportUsager](StructureDefinition-tddui-task-transport-usager.md) | Profil de la ressource TDDUITaskTransport permettant de représenter le transport de l'usager. |
