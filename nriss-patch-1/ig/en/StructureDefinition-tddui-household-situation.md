# TDDUI Household Situation - Médicosocial - Transfert de données DUI v2.4.0-ballot
...
* Use this Extension: [TDDUI Patient INS](StructureDefinition-tddui-patient-ins.md) and [TDDUI Patient](StructureDefinition-tddui-patient.md)
* Examples for this Extension: [Bundle/tddui-bundle-example](Bundle-tddui-bundle-example.md), [Patient/tddui-patient-example](Patient-tddui-patient-example.md) and [Patient/tddui-patient-ins-example](Patient-tddui-patient-ins-example.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ans.fhir.fr.tddui|current/StructureDefinition/StructureDefinition-tddui-household-situation.json)
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "https://mos.esante.gouv.fr/NOS/JDV_J176-SituationVieQuotidienne-MDPH/FHIR/JDV-J176-SituationVieQuotidienne-MDPH|20210924120000"
      }
    },
    {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "https://smt.esante.gouv.fr/fhir/ValueSet/jdv-j385-composition-foyer-ms|20260202120000"
      }
    },
    {
