# TDDUI Task Transport Professionnel - Médicosocial - Transfert de données DUI v2.4.0-ballot
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ans.fhir.fr.tddui|current/StructureDefinition/StructureDefinition-tddui-task-transport-professionnel.json)
...
```json
{
  ...
  "abstract" : false,
  "type" : "Task",
  "baseDefinition" : "https://interop.esante.gouv.fr/ig/fhir/tddui/StructureDefinition/tddui-task-transport|2.4.0-ballot",
