...
| | |
| :--- | :--- |
| *Official URL*:https://interop.esante.gouv.fr/ig/fhir/tddui/StructureDefinition/tddui-encounter-evenement | *Version*:2.3.0-ballot |
| Active as of 2026-03-12 | *Computable Name*:TDDUIEncounterEvenement |
...
```json
{
  ...
  "status" : "active",
  "date" : "2026-03-12T16:28:34+00:00",
  "publisher" : "ANS",
  "contact" : [{
    "name" : "ANS",
    "telecom" : [{
