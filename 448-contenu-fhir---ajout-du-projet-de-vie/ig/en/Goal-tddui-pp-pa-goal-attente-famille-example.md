# TDDUI PP PA Goal Attente Famille Example - Médicosocial - Transfert de données DUI v2.3.0-ballot

## Example Goal: TDDUI PP PA Goal Attente Famille Example

Profile: [TDDUI Goal Attente](StructureDefinition-tddui-goal-attente.md)
