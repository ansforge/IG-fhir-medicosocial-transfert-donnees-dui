# TDDUI Related Person Relashionship - Médicosocial - Transfert de données DUI v2.2.0-ballot
...
| Active as of 2026-02-04 | *Computable Name*:TDDUIRelatedPersonRelashionship |
...
```json
{
  ...
  "compose" : {
    "include" : [
      ...
      {
        "valueSet" : [
          "https://interop.esante.gouv.fr/ig/fhir/tddui/ValueSet/tddui-contact-protection-juridique|2.2.0-ballot"
        ]
      }
    ]
  }
