...
Il existe deux représentations techniques pour le contenu de l'export des données du DUI :
  * une représentation basée sur le standard FHIR afin de s’aligner sur les recommandations européennes et pour s’adapter aux évolutions des cas d’usage de ce volet <a href="sfe_cadre_juridique.html#exemples-de-cas-dusage">"Exemples de cas d'usage"</span></a>.<br>
