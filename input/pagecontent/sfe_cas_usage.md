...
Ce cas d’usage s’inscrit dans le cadre du programme décliné en France, au niveau national pour déployer des solutions numériques au sein des établissements et services sociaux et medico-sociaux (ESSMS), favoriser l’interopérabilité et transférer des données d’un logiciel DUI (données usagers informatisés) vers un Système d’Information tiers.
...
* Il est possible de ré envoyer des éléments déjà transmis – les derniers éléments transmis écrasent les précédents.
* On envoie minimum une semaine d'historique par usager
* On envoie maximum cinq semaines d'historique par usager
