...
* input[accompagnement].type = InputTDDUITaskTransport#accompagnement
* input[accompagnement] ^short = "Accompagnement nécessaire ou non de l'usager"

// Asepsie rigoureuse
* input[asepsieRigoureuse].value[x] only boolean
* input[asepsieRigoureuse].type = InputTDDUITaskTransport#asepsie
...
* input[natureTransport].type = InputTDDUITaskTransport#natureTransport
