...
* extension[decision].extension[motivation] ^short = "Motivation de la décision"
*/

* extension[decision].extension[motivationLocale].value[x] only string
* extension[decision].extension[motivationLocale] ^short = "Motivation locale de la décision"
