RuleSet: PDSM_SimplifiedDR

// FSH de PDSM 3.1.0 excepté les références de type PractitionerRole vers le profil AS
* meta.versionId MS
...
* author 1..
* author only Reference(TDDUIPractitionerRole or TDDUIPractitioner or TDDUIOrganization or TDDUIPatient or TDDUIPatientINS or Device or fr-core-related-person) 
...
* authenticator only Reference(TDDUIPractitionerRole or TDDUIOrganization)
