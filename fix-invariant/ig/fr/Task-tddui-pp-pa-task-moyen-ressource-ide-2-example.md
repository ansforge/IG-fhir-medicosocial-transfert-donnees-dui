# TDDUI PP PA Task Moyen Ressource IDE 2 Example - Médicosocial - Transfert de données DUI v2.4.0-tru

## Exemple Task: TDDUI PP PA Task Moyen Ressource IDE 2 Example
