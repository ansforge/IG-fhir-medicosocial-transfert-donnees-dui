# TDDUI-Consommateur - Médicosocial - Transfert de données DUI v2.4.0-tru
...
Le rôle du Consommateur est de recueillir les données d'un logiciel DUI. Il correspond à un SI tiers. 
 ...
 [Fichier de définition d'OpenAPI-Swagger](../TDDUIConsommateur.openapi.json) | [Télécharger](../TDDUIConsommateur.openapi.json) 
