# TDDUI Planned Absence - Médicosocial - Transfert de données DUI v2.4.0-tru
...
Extension simple avec le type boolean : Absence prévue
...
Autres représentations du profil : [CSV](../StructureDefinition-tddui-planned-absence.csv), [Excel](../StructureDefinition-tddui-planned-absence.xlsx), [Schematron](../StructureDefinition-tddui-planned-absence.sch) 
