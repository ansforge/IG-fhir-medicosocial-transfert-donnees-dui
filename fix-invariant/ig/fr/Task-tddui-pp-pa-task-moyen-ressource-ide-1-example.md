# TDDUI PP PA Task Moyen Ressource IDE 1 Example - Médicosocial - Transfert de données DUI v2.4.0-tru

## Exemple Task: TDDUI PP PA Task Moyen Ressource IDE 1 Example
