# TDDUI PP PA Task Moyen Ressource Ergo 1 Example - Médicosocial - Transfert de données DUI v2.4.0-ballot

##  Task: TDDUI PP PA Task Moyen Ressource Ergo 1 Example
