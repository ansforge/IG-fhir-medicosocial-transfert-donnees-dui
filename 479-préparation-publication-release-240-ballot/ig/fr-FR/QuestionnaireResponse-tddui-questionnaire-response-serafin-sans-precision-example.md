# TDDUI Questionnaire Response SERAFIN Sans Precision Example - Médicosocial - Transfert de données DUI v2.4.0-ballot

##  QuestionnaireResponse: TDDUI Questionnaire Response SERAFIN Sans Precision Example
